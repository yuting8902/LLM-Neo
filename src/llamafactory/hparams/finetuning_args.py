...
class FinetuningArguments(
    ...
    kd_ratio: float = field(
        default=0.5,
        metadata={"help": "The ratio for KD and default is 0.5"},
    )
    ...
    kd_type: Literal["kd", "sft", "neo", "lora"] = field(
        default="sft",
        metadata={"help": "Which stage will be performed in training. chose from kd, sft, neo, lora"},
    )
